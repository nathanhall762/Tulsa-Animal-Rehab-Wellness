      ...
      >
        <div className='z-10 px-4 pb-8 text-left lg:pb-16 lg:pl-16 lg:pr-64'>
          <div className='fade-in-up'>
            <h2 className='text-shadow-xl pb-2 text-xl font-normal text-neutral-1 drop-shadow-xl lg:text-3xl '>
              {welcomeText}
            </h2>
            <h1 className='text-shadow-xl mt-2 text-3xl tracking-widest text-neutral-1 drop-shadow-xl lg:mt-6 lg:text-5xl'>
              {tagline}
            </h1>
          </div>
        </div>
