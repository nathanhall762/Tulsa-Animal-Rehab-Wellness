    ...
    <div className='relative h-[86vh] shadow-inner'>
      ...
      <div className='relative z-10 flex h-full flex-col justify-end text-center lg:text-left'>
        <div className='fade-in-up bg-opacity-80  px-4 py-16 shadow-md lg:px-32'>
          ...
          <h2 className='text-shadow-xl pb-16 lg:w-3/4 text-center text-2xl font-bold text-neutral-1 lg:pb-14 lg:text-left lg:text-5xl'>
            {tagline}
          </h2>
          <div className='flex flex-col items-center gap-4 lg:flex-row lg:gap-16'>
            <a href='/contact' className=''>
              <button className='bg-other hover:bg-accent transform rounded-xl bg-primary-md1 px-12 py-4 text-lg text-neutral-1 hover:font-bold transition duration-300 ease-in-out hover:scale-110 hover:bg-primary-md2'>
                Contact Us
              </button>
            </a>
